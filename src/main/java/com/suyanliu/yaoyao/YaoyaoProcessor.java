...
public class YaoyaoProcessor extends AbstractProcessor {
    ...
    public synchronized boolean process(Set<? extends TypeElement> annotations,
        ...
        Set<? extends Element> set = roundEnv.getElementsAnnotatedWith(Yaoyao.class);
        set.forEach(element -> {
    ...
    private JCTree.JCMethodDecl makeGetterMethodDecl(JCTree.JCVariableDecl jcVariableDecl) {
        ...
        statements.append(treeMaker.Return(treeMaker
                .Select(treeMaker.Ident(names.fromString("this")), jcVariableDecl.getName())));
        JCTree.JCBlock body = treeMaker.Block(0, statements.toList());
        return treeMaker.MethodDef(treeMaker.Modifiers(Flags.PUBLIC),
                getNewMethodName(jcVariableDecl.getName()), jcVariableDecl.vartype, List.nil(),
